...
**本节要点:** `CdbPathLocus` · `locustype` · `numsegments` · `Hashed` · `Strewn` · `Replicated` · `SegmentGeneral` · `from_baserel` · `cdbpathlocus_join` · `co-location`
...
**本节要点:** `cdbpath.c:195` · `cdbpath.c:754` · `cdbpath.c:1365` · `cdbpath.c:2131` · `cdbpath.c:86` · `pathnode.c:3936`
...
**本节要点:** `cdbllize` · `cdbmutate` · `make_motion` · `slices` · `SliceTable` · `Flow`
...
**本节要点:** `two-stage agg` · `Partial→Redistribute→Finalize` · `single-stage co-located` · `direct dispatch` · `cdbhash(const)` · `AGGSPLIT`
