...
**本节要点:** `why cache` · `N+1 caches` · `buffer array` · `pg_buffercache`
...
**本节要点:** `page enters` · `pin & usagecount` · `EXPLAIN buffers`
...
**本节要点:** `miss path` · `clock sweep` · `evict & re-tag`
...
**本节要点:** `cache-trashing` · `the ring` · `threshold`
...
**本节要点:** `three writers` · `bgwriter loop` · `checkpointer` · `pg_stat_bgwriter`
...
**本节要点:** `PG local buffers` · `why shared` · `segmates` · `demo`
