...
**本节要点:** `page layout` · `page header` · `line pointers` · `free-space invariant`
...
**本节要点:** `tuple header` · `infomask hints` · `NULL bitmap` · `TOAST`
...
**本节要点:** `insert` · `update chain` · `delete` · `scan & visibility`
...
**本节要点:** `three forks` · `free space map` · `visibility map` · `all-visible horizon`
...
**本节要点:** `HOT updates` · `version chain` · `page pruning` · `LP_REDIRECT`
...
**本节要点:** `one field, two needs` · `the combo array` · `seeing it on the page` · `sharing across segmates`
